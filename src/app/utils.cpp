...
void display_help()
{
    ...
    cout << "--test with next argument specifiing XML file annotating test data" << endl;
    cout << "  Additional --display argument could be specified to display result in window." << endl;
    cout << "  eg. --test ../test/test.xml or --test ../test/test.xml --display" << endl << endl;
}

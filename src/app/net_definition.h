...
template <typename SUBNET> using rcon3  = relu<bn_con<con3<55,SUBNET>>>; //why 55?
...
//using myNet_type = loss_mmod<con<1,9,9,1,1,rcon5<rcon5<rcon5<downsampler8x<input_rgb_image_pyramid<pyramid_down<6>>>>>>>>;
